...
fwrite($fp, "	<script src='http://redmovil.mobi/editor/RedMovil.RedMovil.UserInterface/ExtLibs/lightboxcel.js'></script>\n");
fwrite($fp, "	<script src='http://redmovil.mobi/editor/RedMovil.RedMovil.UserInterface/ExtLibs/dragdivscroll.js'></script>\n");
fwrite($fp, "	<link href='http://redmovil.mobi/editor/RedMovil.RedMovil.UserInterface/Css/lightbox.css' rel='stylesheet' />\n");
