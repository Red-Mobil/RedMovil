function mostrarRS(){
            ...
            $("#facebook").html(
            '<center><input type="button" id="faceb" class="tt" value="Facebook" onclick="parent.location=\'http://www.facebook.com/'
            ...
            $("#twitter").html(
            '<center></br><center><input id="twitt" class="tt"  type="button" value="Twitter"  onclick="parent.location=\'http://www.twitter.com/'
