	...
	function hacer()
	{
		...
		if (document.getElementById('f1').value != '')
		{
			...
			mandar += '<div class="single first" id=i1><img src="http://redmovil.mobi/editor/RedMovil.RedMovil.UserInterface/Html/paginas' + document.getElementById('f1').value + '"width="100%" float="left" onclick="insertarimagen(\'f1\')" \></div>-skip';
			...
			if (document.getElementById('f3').value != '')
			{
				...
				mandar += '<div class="single last" id=i3><img src="http://redmovil.mobi/editor/RedMovil.RedMovil.UserInterface/Html/paginas' + document.getElementById('f3').value + '"width="100%" float="left" onclick="insertarimagen(\'f3\')" \></div>-skip';
			}
		...
		else if (document.getElementById('f2').value != '')
		{
			objeto += "i";			
			respaldo += 'http://redmovil.mobi/editor/RedMovil.RedMovil.UserInterface/Html/paginas'+document.getElementById('f2').value +'-skip';
			mandar += '<div class="single" id=i2><img src="http://redmovil.mobi/editor/RedMovil.RedMovil.UserInterface/Html/paginas' + document.getElementById('f2').value + '"width="100%" float="left" onclick="insertarimagen(\'f2\')" \></div>-skip';
			if (document.getElementById('f3').value != '')
			{
				objeto += "i";			
				respaldo += 'http://redmovil.mobi/editor/RedMovil.RedMovil.UserInterface/Html/paginas'+document.getElementById('f3').value +'-skip';
